...
static const char* kSilverDefaultConfig = R"JSON({
  ...
  "gestures": {
    "horizontalSlideThreshold": 4.0,
    "slideResetSeconds": 0.18,
    "panPixelsPerUnit": 32.0,
    "wheelDiscreteTolerance": 0.08
  },
  ...
  "display": {
    "//": "Rendering quality. DPI is detected automatically from the active monitor.",
    "msaaSamples": 4
  },
  ...
  "animation": {
    ...
    "enabled": true,
    "speedMultiplier": 1.0,
    "regroupStartScale": 0.88,
    "regroupEnterOffset": 24.0,
    "regroupMaxSizeRatio": 1.18,
    "scrollRate": 20.0,
    ...
    "layoutMargin": 700,
    "//maxVisibleLayoutTravel": "Long reflows snap instead of sending tiles across the viewport.",
    "maxVisibleLayoutTravel": 180,
    "toastSeconds": 2.0,
    "zoomPillSeconds": 2.0,
    ...
    "spring": {
      "tile":         { "frequency": 4.0, "damping": 1.00, "response": 0.0 },
      "scroll":       { "frequency": 4.0, "damping": 1.00, "response": 0.0 },
      "sidebar":      { "frequency": 3.2, "damping": 1.00, "response": 0.0 },
      "fullscreen":   { "frequency": 4.0, "damping": 1.00, "response": 0.0 },
      "hover":        { "frequency": 4.0, "damping": 0.85, "response": 0.0 },
      "select":       { "frequency": 4.0, "damping": 0.90, "response": 0.0 },
      "zoomPopup":    { "frequency": 4.0, "damping": 1.00, "response": 0.0 },
      "themeMenu":    { "frequency": 4.0, "damping": 1.00, "response": 0.0 },
      "tabIndicator": { "frequency": 4.0, "damping": 1.00, "response": 0.0 },
      ...
      "viewerPopup":      { "frequency": 4.0, "damping": 1.00, "response": 0.0 },
  ...
  "thumbnails": {
    ...
    "useSharedCache": true,
    "diskCacheQuality": 85,
    "//previewMaxEdge": "0 keeps full source resolution for a pixel-perfect fullscreen viewer; set a pixel cap to reduce memory use.",
    "previewMaxEdge": 0,
    "prewarmLibrary": true,
